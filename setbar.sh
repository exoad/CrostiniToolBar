...
echo -e "\e[32mDefault Colors: cyan, green, blue, red, black, gray, yellow, or reset to revert the color to the default."
echo -e "\e[0mExample custom color: #6fe8be"
...
elif [ "$clr" == "gray" ] || [ "$clr" == "Gray" ] || [ "$clr" == "grey" ] || [ "$clr" == "Grey" ]
then
